 ...
 * License: MIT
 */
angular.module("ui.bootstrap", ["ui.bootstrap.transition", "ui.bootstrap.collapse", "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.bindHtml", "ui.bootstrap.buttons", "ui.bootstrap.carousel", "ui.bootstrap.position", "ui.bootstrap.datepicker", "ui.bootstrap.dropdownToggle", "ui.bootstrap.modal", "ui.bootstrap.pagination", "ui.bootstrap.tooltip", "ui.bootstrap.popover", "ui.bootstrap.progressbar", "ui.bootstrap.rating", "ui.bootstrap.tabs", "ui.bootstrap.timepicker", "ui.bootstrap.typeahead","ui.bootstrap.datetimepicker"]);
...
// and adds an accordion CSS class to itself element.
    .directive('accordion', function () {
        return {
            ...
            transclude: true,
            replace: false,
            templateUrl:'/static/app/templates/directives/bootstrap/accordion/accordion.html'
        };
    })
...
// The accordion-group directive indicates a block of html that will expand and collapse in an accordion
    .directive('accordionGroup', ['$parse', function ($parse) {
        return {
            ...
            templateUrl:'/static/app/templates/directives/bootstrap/accordion/accordion-group.html',
...
angular.module("ui.bootstrap.alert", [])
    ...
    .directive('alert', function () {
        return {
            ...
            templateUrl:'/static/app/templates/directives/bootstrap/alert/alert.html',
            transclude: true,
            replace: true,
            scope: {
                type: '=',
 ...
 */
    .directive('carousel', [function () {
        return {
            ...
            require: 'carousel',
            templateUrl:'/static/app/templates/directives/bootstrap/carousel/carousel.html',
            scope: {
                interval: '=',
                noTransition: '=',
                noPause: '='
 ...
 */
    ...
    .directive('slide', ['$parse', function ($parse) {
        return {
            ...
            transclude: true,
            replace: true,
            templateUrl:'/static/app/templates/directives/bootstrap/carousel/slide.html',
            scope: {
            },
...
angular.module('ui.bootstrap.datepicker', ['ui.bootstrap.position'])
    ...
    .directive('datepicker', ['dateFilter', '$parse', 'datepickerConfig', '$log', function (dateFilter, $parse, datepickerConfig, $log) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl:'/static/app/templates/directives/bootstrap/datepicker/datepicker.html',
            scope: {
                dateDisabled: '&'
            },
            ...
            link: function (scope, element, attrs, ctrls) {
              ...
              /*  var dataLess = new Date(); // instancia um objeto da classe Date com a data do sistema.
                dataLess.setDate(dataLess.getDate() - 6);
                
                datepickerCtrl.minDate = new Date(dataLess);*/
                if (attrs.max) {
               ...
               /* var dataMore = new Date(); // instancia um objeto da classe Date com a data do sistema.
                dataMore.setDate(dataMore.getDate() + 6);
                
                datepickerCtrl.maxDate = new Date(dataMore);*/
     ...
     .directive('datepicker2', ['dateFilter', '$parse', 'datepickerConfig', '$log', function (dateFilter, $parse, datepickerConfig, $log) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl:'/static/app/templates/directives/bootstrap/datepicker/datepicker.html',
            ...
            link: function (scope, element, attrs, ctrls) {
                ...
                var dataLess = new Date(); // instancia um objeto da classe Date com a data do sistema.
                dataLess.setDate(dataLess.getDate());
               ...
               /* var dataMore = new Date(); // instancia um objeto da classe Date com a data do sistema.
                dataMore.setDate(dataMore.getDate() + 8);*/
    ...
    .directive('datepickerPopupWrap', function () {
        return {
            ...
            replace: true,
            transclude: true,
            templateUrl:'/static/app/templates/directives/bootstrap/datepicker/popup.html',
            link: function (scope, element, attrs) {
 ...
 */
    .directive('modalBackdrop', ['$timeout', function ($timeout) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl:'/static/app/templates/directives/bootstrap/modal/backdrop.html',
            link: function (scope) {
    ...
    .directive('modalWindow', ['$modalStack', '$timeout', function ($modalStack, $timeout) {
        return {
            ...
            replace: true,
            transclude: true,
            templateUrl:'/static/app/templates/directives/bootstrap/modal/window.html',
            link: function (scope, element, attrs) {
...
angular.module('ui.bootstrap.pagination', [])
    ...
    .directive('pagination', ['$parse', 'paginationConfig', function ($parse, config) {
        return {
            ...
            templateUrl:'/static/app/templates/directives/bootstrap/pagination/pagination.html',
            replace: true,
    ...
    .directive('pager', ['pagerConfig', function (config) {
        return {
            ...
            controller: 'PaginationController',
            templateUrl:'/static/app/templates/directives/bootstrap/pagination/pager.html',
            replace: true,
            link: function (scope, element, attrs, paginationCtrl) {
   ...
   *   });
    ...
    .directive('tooltipPopup', function () {
        return {
            ...
            templateUrl:'/static/app/templates/directives/bootstrap/tooltip/tooltip-popup.html'
        };
    })
    ...
    .directive('tooltipHtmlUnsafePopup', function () {
        return {
            ...
            replace: true,
            scope: { content: '@', placement: '@', animation: '&', isOpen: '&' },
            templateUrl:'/static/app/templates/directives/bootstrap/tooltip/tooltip-html-unsafe-popup.html'
        };
    })
...
angular.module('ui.bootstrap.popover', [ 'ui.bootstrap.tooltip' ])
    ...
    .directive('popoverPopup', function () {
        return {
            ...
            templateUrl:'/static/app/templates/directives/bootstrap/popover/popover.html'
        };
    })
    ...
    .directive('popoverTemplatePopup', [ '$http', '$templateCache', '$compile', '$timeout', function ($http, $templateCache, $compile, $timeout) {
        return {
            ...
            templateUrl: '/static/app/templates/directives/bootstrap/popover/popover-template.html',
                ...
                scope.$watch('content', function (templateUrl) {
                    ...
                    $http.get(templateUrl, { cache: $templateCache })
                        .then(function (response) {
                            ...
                            contentEl.append($compile(response.data.trim())(scope.$parent.$parent));
                            $timeout(function () {
...
angular.module('ui.bootstrap.progressbar', ['ui.bootstrap.transition'])
    ...
    .directive('progress', function () {
        return {
            ...
            //templateUrl:'/static/app/templates/directives/bootstrap/progressbar/progress.html' // Works in AngularJS 1.2
        };
    })
    ...
    .directive('bar', function () {
        return {
            ...
            templateUrl:'/static/app/templates/directives/bootstrap/progressbar/bar.html',
    ...
    .directive('progressbar', function () {
        return {
            ...
            templateUrl:'/static/app/templates/directives/bootstrap/progressbar/progressbar.html',
            link: function (scope, element, attrs, progressCtrl) {
...
angular.module('ui.bootstrap.rating', [])
    ...
    .directive('rating', function () {
        return {
            ...
            templateUrl:'/static/app/templates/directives/bootstrap/rating/rating.html',
            replace: true
        };
    });
 ...
 */
    .directive('tabset', function () {
        return {
            ...
            templateUrl:'/static/app/templates/directives/bootstrap/tabs/tabset.html',
            link: function (scope, element, attrs) {
 ...
 */
    .directive('tab', ['$parse', function ($parse) {
        return {
            ...
            restrict: 'EA',
            replace: true,
            templateUrl:'/static/app/templates/directives/bootstrap/tabs/tab.html',
            transclude: true,
            scope: {
                heading: '@',
...
angular.module('ui.bootstrap.timepicker', [])
    ...
    .directive('timepicker', ['$parse', '$log', 'timepickerConfig', '$locale', function ($parse, $log, timepickerConfig, $locale) {
        return {
            ...
            replace: true,
            scope: {},
            templateUrl:'/static/app/templates/directives/bootstrap/timepicker/timepicker.html',
 ...
 */
    ...
    .directive('typeaheadPopup', function () {
        return {
            ...
            replace: true,
            templateUrl:'/static/app/templates/directives/bootstrap/typeahead/typeahead-popup.html',
            link: function (scope, element, attrs) {
